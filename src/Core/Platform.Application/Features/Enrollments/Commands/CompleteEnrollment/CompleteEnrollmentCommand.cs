...
/// <summary>
/// Command to mark enrollment as completed.
/// </summary>
public sealed record CompleteEnrollmentCommand(Guid EnrollmentId) : IRequest<Result>, IResolvableCacheInvalidatingCommand
{

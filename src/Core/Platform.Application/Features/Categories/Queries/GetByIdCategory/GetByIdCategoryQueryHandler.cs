...
public sealed class GetByIdCategoryQueryHandler(
    ...
    : IRequestHandler<GetByIdCategoryQuery, Result<GetByIdCategoryQueryDto>>
{
        ...
        CancellationToken ct)
    {
        ...
        if (category is null)
            return Result.Fail<GetByIdCategoryQueryDto>("CATEGORY_NOT_FOUND", CategoryBusinessMessages.NotFoundById);
